...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'djoser', #djoser should come After rest-framework and admin
...
REST_FRAMEWORK = {
    ...
    #How much requests can do User and Anonymous
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'anon': '200/min',  # Лимит для AnonRateThrottle
        'low_request': '100/min'
    }
}
